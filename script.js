let appId = '3ee2ba5d7d0aaee278014aff3f5e1427';
let units = 'imperial'; // other option is metric
let searchMethod; 'zip';// q means searching as a string.
...
function setPositionForWeatherInfo() {
    ...
    weatherContainer.style.left = `calc(10% - ${weatherContainerWidth/400}px)`;
